...
class CsvExport {
  ...
  public static function activate_weekly_export() {
    ...
    if ( ! wp_next_scheduled( \MVIFileAttatchmentBase::PLUGIN_PREFIX . 'export_file' ) ) {
      wp_schedule_event( strtotime('Monday 16:00'), 'weekly', \MVIFileAttatchmentBase::PLUGIN_PREFIX . 'export_file' );
    }
  }

  public static function deactivate_weekly_export() {
      wp_clear_scheduled_hook( \MVIFileAttatchmentBase::PLUGIN_PREFIX . 'export_file' );
  }
}
